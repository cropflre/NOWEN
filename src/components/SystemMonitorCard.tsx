...
// ============================================
function ECGWave({ cpuLoad: rawCpuLoad }: { cpuLoad: number }) {
...
// ============================================
function LiquidOrb({ memUsage: rawMemUsage }: { memUsage: number }) {
  ...
  const color = useMemo(() => {
    ...
    if (clampedMemUsage >= 60) return '#f59e0b'
    return '#06b6d4'
  }, [clampedMemUsage])
  ...
  return (
    <div className="relative w-20 h-20 mx-auto">
      ...
      {/* 玻璃球体 */}
      <div className="absolute inset-0 rounded-full overflow-hidden border border-white/20 bg-black/30 backdrop-blur-sm">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <span className="text-xs font-mono text-white/80 drop-shadow-lg">
...
// ============================================
function DiskRing({ diskUsage: rawDiskUsage, diskFree: rawDiskFree }: { diskUsage: number; diskFree: number }) {
  ...
  const color = useMemo(() => {
    ...
    if (clampedDiskUsage >= 70) return '#f59e0b'
    return '#667eea'
  }, [clampedDiskUsage])
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <AnimatePresence mode="wait">
          {isHovered ? (
            ...
            >
              <div className="text-[10px] text-white/60">剩余</div>
  ...
  return (
    <div className={cn(
      ...
      <div className="relative z-10 flex items-center gap-2 mb-4">
        ...
        <span className="text-sm font-medium text-white/80">引擎室</span>
      ...
      <div className="relative z-10 space-y-4">
        ...
        <div className="space-y-2">
          ...
          <div className="h-16 rounded-lg bg-black/30 overflow-hidden border border-white/5">
            <ECGWave cpuLoad={stats.cpuLoad} />
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            ...
            <LiquidOrb memUsage={stats.memUsage} />
          </div>
          ...
          <div className="space-y-2">
            ...
            <DiskRing diskUsage={stats.diskUsage} diskFree={stats.diskFree} />
          </div>
        </div>

        {/* 运行时间 */}
        <motion.div 
          className="flex items-center justify-center gap-2 text-xs text-white/50 pt-2 border-t border-white/5"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ delay: 0.5 }}
        >
          <span>运行时间:</span>
          <span className="font-mono text-white/70">{stats.uptime}</span>
        </motion.div>
      </div>
      ...
      <AnimatePresence>
        {error && (
          <motion.div
            className="absolute bottom-2 left-2 right-2 text-xs text-red-400 bg-red-500/10 rounded px-2 py-1 z-20"
