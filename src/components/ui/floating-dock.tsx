        ...
        {isCollapsed ? (
          <motion.button
            ...
            style={{
              ...
              background: isDark ? 'rgba(17, 19, 28, 0.74)' : 'rgba(255, 255, 255, 0.72)',
              border: '1px solid var(--ambient-control-border, var(--color-glass-border))',
              backdropFilter: 'blur(28px) saturate(145%)',
              WebkitBackdropFilter: 'blur(28px) saturate(145%)',
              boxShadow: isDark
                ? '0 18px 50px rgba(0, 0, 0, 0.34), inset 0 1px 0 rgba(255,255,255,0.05)'
                : '0 18px 50px rgba(63, 76, 116, 0.12), inset 0 1px 0 rgba(255,255,255,0.74)',
            }}
          ...
          <motion.div
            ...
            style={{
              background: isDark ? 'rgba(17, 19, 28, 0.72)' : 'rgba(255, 255, 255, 0.68)',
              border: '1px solid var(--ambient-control-border, var(--color-glass-border))',
              ...
              boxShadow: isDark
                ...
                : '0 24px 70px rgba(63, 76, 116, 0.13), inset 0 1px 0 rgba(255,255,255,0.74)',
            }}
    ...
    >
      <AnimatePresence>
        {isHovered && !isSubmenuOpen && (
          <motion.div
            className="pointer-events-none absolute bottom-[calc(100%+10px)] left-1/2 -translate-x-1/2 whitespace-nowrap rounded-lg px-2.5 py-1.5 text-[11px]"
            style={{
              color: 'var(--color-text-primary)',
              background: isDark ? 'rgba(13, 15, 22, 0.9)' : 'rgba(255, 255, 255, 0.9)',
      ...
      <AnimatePresence>
        {isSubmenuOpen && item.subItems && (
          <motion.div
            className="absolute bottom-[calc(100%+12px)] left-1/2 min-w-[190px] -translate-x-1/2 rounded-2xl p-2"
            style={{
              background: isDark ? 'rgba(16, 18, 27, 0.92)' : 'rgba(255, 255, 255, 0.9)',
              border: '1px solid var(--ambient-control-border, var(--color-glass-border))',
